...
Send an email to the list with the Subject line: [Committer School] I would like to become a committerand the Message body:I am interested in the following areas:  _______, _______ and ______If anyone knows any issues that I could take a look at I would be very much appreciatedThanks
...
Make sure that nobody else is working on the issue and that the issue is one that should be fixed by sending an email to the list with a Subject line something like:[Committer School] Should I fix MNG-4612?The Message body should be something like:I have had a look at MNG-4612 and I think this is a real issue because...I think I can fix it like so....Is that the correct way to go about fixing it and is it a real issue at allThanks

Wait a couple of days. Arnaud, Barrie and I will do our best to respond quickly to all such emails, but please keep in mind that we are doing this in our spare time.

If you get the all clear, develop your patch and upload it to the JIRA, after it is uploaded, send an email to the list with a subject line something like:[Committer School] Patch for review: MNG-4612The Message body should be something like:I have tested that this is a good patch and I would appreciate if a committer could review and applyThanks
...
†the Maven project may well move to GIT at some point in the future but for now we are using Subversion

‡or a good patch a month for a year