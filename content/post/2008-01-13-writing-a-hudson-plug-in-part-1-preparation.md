...
You can get JUnit.jar from [http://www.junit.org](http://www.junit.org/).

The JavaNCSS jars are available at [http://www.kclee.de/clemens/java/javancss/](http://www.kclee.de/clemens/java/javancss/) (Note this is the .de domain, not the .com domain). JavaNCSS comes as a zip file, so we’ll just extract the three jar files that we need: `ccl.jar`, `javancss.jar` and `jhbasic.jar`
...
Now fire up a web browser for [http://localhost:8080/](http://localhost:8080/)

![](/images/post/2008-01-13-image1.jpg)
...
![](/images/post/2008-01-13-image2.jpg)
