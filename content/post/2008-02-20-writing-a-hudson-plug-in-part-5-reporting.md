---
title: "Writing a Hudson plug-in (Part 5 – Reporting)"
...
_[Correction]_ We also need to modify `BuildProxy` so that it calls our setter for us for actions added from slave side executions:
