...
Hence why, [since 2007](http://jenkins-ci.361315.n4.nabble.com/plugins-disabled-when-using-m2-build-td367093.html), I have been saying that the Maven job type is considered evil…
...
* well actually three ways[^1] if you include the literate job type

[^1]: (Update 2017-08-01) well actually four ways if you include pipeline and the `withMaven` helper